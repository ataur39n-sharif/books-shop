...
export default function SearchFilterComponent() {
    ...
    return (
        <Row>
            ...
            <Col sm={12}>
                <span><Switch defaultChecked={activeFilter}
                              onChange={() => setActiveFilter(!activeFilter)}/>Filter</span>
            </Col>
            {
                activeFilter && <Col sm={6} className="p-3">
                    <div className="bg-light p-3">
                        <Form.Group as={Row} className="mb-3" controlId="formHorizontalEmail">
                            ...
                            <Col sm={7}>
                                <Form.Control type="text" placeholder="Type a genre"
                                              onChange={({target}) => setFilter({...filter, genre: target.value})}/>
                            </Col>
                        </Form.Group>
                        ...
                        <Form.Group as={Row} className="mb-3" controlId="formHorizontalPassword">
                            ...
                            <Col sm={7}>
                                <Form.Control type="date" placeholder="select date" onChange={({target}) => setFilter({
                                    ...filter,
                                    publicationDate: target.value
                                })}/>
                            </Col>
                        </Form.Group>
                    </div>
